...
can simply provide an implementation of the Ayl::Engine interface (described below). If you would like to leverage asynchronous processes in your rails application, take 
a look at {ayl-rails}[https://github.com/j0hnds/ayl-rails]; it provides the ability to asynchronize ActiveRecord callbacks (e.g. after_save, after_update, etc.).
